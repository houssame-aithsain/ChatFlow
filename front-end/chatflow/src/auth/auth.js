                ...
                <div className={`container ${isRightPanelActive ? 'right-panel-active' : ''}`}>
                    <div className="form-container sign-up-container">
                        <form action="#">
                            ...
                            <button onClick={(e) => { e.preventDefault(); Register(email, password, first_name, last_name, username, setIsRightPanelActive, setNotifications); setIsRightPanelActive(true) }}>
                                Sign Up
                            </button>
                        </form>
                    </div>
